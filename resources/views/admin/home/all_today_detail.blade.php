                ...
                <div class="am-g am-g-collapse">
                    <div class="am-u-sm-12">
                        <form class="am-form">
                            ...
                            <div class="am-cf">
                                共 {{$all_today_records->total()}} 条记录
                                <div class="am-fr">
                                    {!! $all_today_records->appends(Request::all())->links() !!}
                                </div>
                            </div>
                        </form>
                    </div>
